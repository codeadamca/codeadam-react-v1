  ...
  render() {
    return (
      <div className="Colour">
        ...
        <p>
          <a href="/instructions/building-instructions-line.html">
        ...
        <pre>
          <code class="hljs coffeescript">
            ...
            <span class="hljs-built_in">print</span>, wait, StopWatch
            {"\n"}
            ...
            <span class="hljs-string">"Current Color: "</span>
            +str(colorSensor.color()))
            {"\n"}
            {"\n"}
        ...
        <p>
          Using the provided electrical tape, create a line on your desk
        ...
        <p>
          Using the provided electrical tape, create a shape on your desk
          resembling something like this:
        </p>
        ...
        <p>
          Submit both of your your <code>main.py</code> files and a list of
          group members that were present in Blackboard.
        </p>
