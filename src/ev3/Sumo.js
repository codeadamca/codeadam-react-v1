  ...
  render() {
    return (
      <div className="Sumo">
        ...
        <p>
          <a href="/instructions/building-instructions-sumo.html">
        ...
        <p>
          The colour sensor will provide a number representing which color it is
          currenlty sensing:
        </p>
        ...
        <p>
          You may use the provided electrical tape to make a sumo ring on your
          desk. For the competition we will use the wooden ring in the center of
          the classrooms:
        </p>
        ...
        <p>
          Code your LEGO sumo robot to stay within the sumo ring and push the
          other robot out.
        </p>
        ...
        <p>
          Submit your <code>main.py</code> files and a list of group members
          that were present in Blackboard.
        </p>
